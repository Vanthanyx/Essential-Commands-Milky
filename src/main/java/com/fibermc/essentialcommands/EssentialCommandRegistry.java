...
public final class EssentialCommandRegistry {
        ...
        public static void register(
                ...
                if (CONFIG.ENABLE_HOME) {
                        ...
                        LiteralArgumentBuilder<ServerCommandSource> homeTpOtherBuilder = CommandManager
                                        .literal("tp_other");
                        LiteralArgumentBuilder<ServerCommandSource> homeTpOfflineBuilder = CommandManager
                                        .literal("tp_offline");
                        LiteralArgumentBuilder<ServerCommandSource> homeDeleteBuilder = CommandManager
                                        .literal("delete");
                        LiteralArgumentBuilder<ServerCommandSource> homeListBuilder = CommandManager.literal("list");
                        LiteralArgumentBuilder<ServerCommandSource> homeListOfflineBuilder = CommandManager
                                        .literal("list_offline");
                        ...
                        LiteralCommandNode<ServerCommandSource> hNode = hBuilder
                ...
                if (CONFIG.ENABLE_WARP) {
                        ...
                        LiteralArgumentBuilder<ServerCommandSource> warpTpOtherBuilder = CommandManager
                                        .literal("tp_other");
                        LiteralArgumentBuilder<ServerCommandSource> warpDeleteBuilder = CommandManager
                                        .literal("delete");
                        ...
                        warpListBuilder
                                        ...
                                        .executes(ListCommandFactory.create(
                                                        ...
                                                        "warp tp",
                                                        (context) -> ManagerLocator.getInstance().getWorldDataManager()
                                                                        .getWarpEntries()));
                ...
                if (CONFIG.ENABLE_NICK) {
                        ...
                        LiteralArgumentBuilder<ServerCommandSource> nickRevealBuilder = CommandManager
                                        .literal("reveal");

                        Predicate<ServerCommandSource> permissionSelf = ECPerms.require(ECPerms.Registry.nickname_self,
                                        2);
                        Predicate<ServerCommandSource> permissionOther = ECPerms
                                        .require(ECPerms.Registry.nickname_others, 2);
                        nickSetBuilder.requires(permissionSelf)
                                        ...
                                        .then(CommandUtil.targetPlayerArgument()
                                                        ...
                                                        .then(argument("nickname", TextArgumentType.text())
                                                                        .executes(new NicknameSetCommand()))
                                                        .then(argument("nickname_placeholder_api",
                ...
                if (CONFIG.ENABLE_INVULN) {
                        registerNode.accept(
                                        CommandManager.literal("invuln")
                                                        ...
                                                        .then(CommandUtil.targetPlayerArgument()
                                                                        .requires(ECPerms.require(
                                                                                        ECPerms.Registry.invuln_others,
                                                                                        2))
                                                                        .then(argument("invuln_enabled",
                ...
                registerNode.accept(CommandManager.literal("lastPos")
                                ...
                                .then(argument("target_player", StringArgumentType.word())
                                                .executes((context) -> {
                                                        var targetPlayerName = StringArgumentType.getString(context,
                                                                        "target_player");
                                                        ManagerLocator.getInstance()
                                                                        ...
                                                                        .whenComplete((playerEntity, err) -> {
                                                                                if (playerEntity == null) {
                                                                                        context.getSource()
                                                                                                        .sendError(Text.of(
                                                                                                                        "No player with the specified name found."));
                                                                                        return;
                                                                                }
                                                                                context.getSource().sendFeedback(
                                                                                                Text.of(playerEntity
                                                                                                                .getPos()
                                                                                                                .toString()),
                ...
                LiteralCommandNode<ServerCommandSource> configNode = CommandManager.literal("config")
                                ...
                                .then(CommandManager.literal("reload")
                                                .executes((context) -> {
                                                        ...
                                                        var ecText = player != null ? ECText.access(player)
                                                                        : ECText.getInstance();
                                                        context.getSource().sendFeedback(
                                ...
                                .then(CommandManager.literal("display")
                                                ...
                                                .then(CommandManager
                                                                .argument("config_property", StringArgumentType.word())
                                                                .suggests(ListSuggestion.of(
                                                                                BACKING_CONFIG::getPublicFieldNames))
                                                                .executes(context -> {
                                                                        try {
                                                                                context.getSource().sendFeedback(
                                                                                                BACKING_CONFIG.getFieldValueAsText(
                                                                                                                StringArgumentType
                                                                                                                                .getString(context,
                                                                                                                                                "config_property")),
                                                                                                false);
