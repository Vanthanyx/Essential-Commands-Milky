...
public class PlayerData extends PersistentState implements IServerPlayerEntityData, IFeedbackReceiver {
    ...
    public void addHome(String homeName, MinecraftLocation minecraftLocation) throws CommandSyntaxException {
        int playerMaxHomes = ECPerms.getHighestNumericPermission(this.player.getCommandSource(),
                ECPerms.Registry.Group.home_limit_group);
    ...
    public void onTickEnd() {
        ...
        } else if (CONFIG.AUTO_AFK_ENABLED
    ...
    public void fromNbt(NbtCompound tag) {
        ...
        if (dataTag.contains(StorageKey.NICKNAME)) {
            ...
            try {
                ...
                EssentialCommands.LOGGER
                        .warn("Could not refresh player full nickanme, as ServerPlayerEntity was null in PlayerData.");
            }
        }
    ...
    public void updatePlayerEntity(ServerPlayerEntity serverPlayerEntity) {
        ...
        // This is to fix a bug with ability to fly being lost upon being teleported to
        // a new dim via /execute...tp.
